...
// tests (the deterministic offline gate + the key-gated live test, which
...
export default defineConfig({
  ...
  test: {
    environment: "node",
    include: [
      "tests/open-prose/examples/inbox-triage/inbox-triage.test.ts",
      "tests/open-prose/examples/inbox-triage/inbox-triage.live.test.ts",
    ],
