...
// the offline gate alongside their co-located tier-2 ledger-replay tests.
//
...
//
// RUN: cd /Users/sl/code/prose && npx vitest run tests/open-prose/examples
...
// LIST IN LOCKSTEP with the examples whose co-located *.test.ts run green in the
// shared vitest gate (skills/open-prose/examples/**). Partial/WIP examples are
...
const OWNED_EXAMPLES = [
	...
	// green, gated tier-2 ledger-replay tests.
	"agent-observatory",
	"basic-unit-suite",
	"forme-fixpoint",
